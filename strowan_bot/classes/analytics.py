...
try:
    ...
    pm.execute_notebook('../../../analytics.ipynb', '../../../nad_app/static/reports/analytics' + "_" + current_date +'.ipynb', parameters = dict())
...
try:
    ...
    nbconverttohtml_nocode ="/home/s0288/.virtualenvs/my-virtualenv/bin/jupyter nbconvert --ExecutePreprocessor.kernel_name=python3.6 --template=nbextensions --to=html ../../../nad_app/static/reports/analytics" + "_" + current_date + ""
    os.system(nbconverttohtml_nocode)
    # remove the original jupyter file to save space
    print('removing jupyter notebook...')
    os.remove('../../../nad_app/static/reports/analytics' + "_" + current_date + '.ipynb' + "")
except Exception as e:
